  ...
  return (
    <div className="w-full container max-w-[500px]">
       <div className="tab_panel mx-auto">
            <div
              className={`tab_button py-[2px!important]  ${active === 0 ? "main_btn hover:scale-[100%!important] hover:bg-[white!important] hover:text-[black!important]" : ""}`}
              onClick={() => setActive(0)}
            >
              Sale
            </div>
            <div
              className={`tab_button py-[2px!important]  ${active === 1 ? "main_btn hover:scale-[100%!important] hover:bg-[white!important] hover:text-[black!important]" : ""}`}
              onClick={() => setActive(1)}
            >
              Claim
            </div>
