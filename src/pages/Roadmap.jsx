...
export default function Roadmap() {
  return (
    <div className="max-w-[1200px] mx-auto container">
      ...
      <div class="space-y-8 mt-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          <div class="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 snow_effect text-slate-500 group-[.is-active]:text-emerald-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
            <svg
              class="fill-current"
          ...
          <div class="w-[calc(100%-2rem)] md:w-[calc(50%-0.5rem)] p-4 rounded snow_effect ">
            <div class="flex items-center justify-between space-x-2 mb-1">
              <div class="font-bold"></div>
              <time class="font-caveat font-medium text-white">
        ...
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div class="w-[calc(100%-2rem)] md:w-[calc(50%-0.5rem)] p-4 rounded snow_effect ">
            <div class="flex items-center justify-between space-x-2 mb-1">
              <div class="font-bold"></div>
              <time class="font-caveat font-medium text-white">The Future</time>
            </div>
            <div class="text-white text-sm">
        ...
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div class="w-[calc(100%-2rem)] md:w-[calc(50%-0.5rem)] p-4 rounded snow_effect ">
            <div class="flex items-center justify-between space-x-2 mb-1">
              <div class="font-bold"></div>
              <time class="font-caveat font-medium text-white">Conclusion</time>
            </div>
            <div class="text-white text-sm">
